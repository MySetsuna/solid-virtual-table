...
type Field = 'id' | 'color' | 'name' | 'img' | 'imgUrl';
            ...
            <div class={styles.row}>
              <For each={store.fields}>
                {(field) => {
                  return (
                    <Dynamic
                      component={Reflect.get(fieldMaps, field)}
                      onChange={(value: string) => {
                        if (field === 'img') {
                          setStore(
                            'rows',
                            (rowItem, index) => index === rowIndex(),
                            'imgUrl',
                            () => value
                          );
                        }
